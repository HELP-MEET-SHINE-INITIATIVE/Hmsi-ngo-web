...
export default function AdminControlContent() {
  ...
  const [activeView, setActiveView] = useState<'overview' | 'analytics' | 'training' | 'fundraisers' | 'volunteers' | 'opportunities' | 'donations' | 'messages' | 'newsletter' | 'stories' | 'news' | 'moderation' | 'assignments'>('overview');
