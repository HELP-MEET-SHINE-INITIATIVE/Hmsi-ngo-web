...
import { AlertCircle, Calendar, CheckCircle2, ClipboardList, LogOut, ShieldCheck, UserPlus, Users, XCircle } from 'lucide-react';
...
export default function AdminControlContent() {
  ...
  const [activeView, setActiveView] = useState<'overview' | 'fundraisers' | 'volunteers' | 'opportunities' | 'assignments'>('overview');
