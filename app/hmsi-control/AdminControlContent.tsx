  ...
  return (
    <div className="min-h-screen bg-[#f6f4ef] text-[#17221e]">
      ...
      <main className="mx-auto grid max-w-7xl gap-8 px-6 py-8 lg:grid-cols-[230px_1fr]">
        <Link href="/admin/presidents-office" className="lg:col-span-2 flex items-center justify-between gap-4 rounded-3xl border border-[#1e5b49]/25 bg-[#e9f0e9] px-5 py-4 text-sm font-black text-[#1e5b49] hover:bg-[#dcebdc]"><span>President’s Office: approved people, official-notification readiness, and work awaiting approval</span><span className="shrink-0 text-xs uppercase tracking-widest underline">Open workspace</span></Link>
