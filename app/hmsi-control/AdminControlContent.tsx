...
export default function AdminControlContent() {
  ...
  const [activeView, setActiveView] = useState<'overview' | 'fundraisers' | 'volunteers' | 'opportunities' | 'donations' | 'messages' | 'newsletter' | 'assignments'>('overview');
