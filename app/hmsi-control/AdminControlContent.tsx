...
export default function AdminControlContent() {
  ...
  const [opportunityForm, setOpportunityForm] = useState({ title: '', description: '', audience: 'volunteer', location: 'Nigeria and Africa', image_url: '', image_path: '', startsAt: '', endsAt: '', category: 'general', eligibility_note: '', requires_hmsi_certificate: false, member_visible: false });
  ...
  const createOpportunity = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setOpportunityForm({ title: '', description: '', audience: 'volunteer', location: 'Nigeria and Africa', image_url: '', image_path: '', startsAt: '', endsAt: '', category: 'general', eligibility_note: '', requires_hmsi_certificate: false, member_visible: false });
      await loadOverview();
