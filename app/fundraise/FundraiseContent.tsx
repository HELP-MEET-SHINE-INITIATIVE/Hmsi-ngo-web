      ...
      <main>
        ...
        <section className="bg-[#e9f0e9] px-6 py-20">
          <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 lg:grid-cols-2">
            <div><h2 className="mb-6 text-4xl font-black tracking-tight">Safe, Secure and <br /><span className="text-[#1e5b49]">100% Transparent.</span></h2><p className="mb-10 text-lg leading-relaxed text-[#66716a]">HMSI publishes approved causes with current campaign information, responsible updates, and official donation channels. Supporters should review each campaign before giving.</p><div className="mb-8 rounded-2xl border border-[#d9d6ce] bg-white p-5 text-xs leading-5 text-[#66716a]"><p><strong className="text-[#17221e]">Organisation:</strong> The Incorporated Trustees of HELP-MEET SHINE INITIATIVE · CAC/IT/NO 125103.</p><p className="mt-2"><strong className="text-[#17221e]">FIRS tax identification:</strong> TIN 21249981, as shown on the supplied FIRS taxpayer-results record. This is a tax identifier, not a tax-exemption certificate. HMSI does not describe donations as tax-exempt or tax-deductible unless the applicable authority confirms that status.</p></div><div className="grid grid-cols-2 gap-6"><div className="rounded-2xl bg-white p-6 shadow-sm"><p className="text-2xl font-black text-[#1e5b49]">Review</p><p className="text-[10px] font-black uppercase tracking-widest text-[#66716a]">Approved causes</p></div><div className="rounded-2xl bg-white p-6 shadow-sm"><p className="text-2xl font-black text-[#1e5b49]">Official</p><p className="text-[10px] font-black uppercase tracking-widest text-[#66716a]">Donation channels</p></div></div></div>
