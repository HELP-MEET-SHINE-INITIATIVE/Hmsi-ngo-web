        ...
        <div className="flex w-full flex-col justify-center bg-slate-50 p-8 md:p-16 lg:w-1/2">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div><label htmlFor="volunteer-location" className="mb-2 block text-xs font-bold uppercase text-slate-600">Location</label><input id="volunteer-location" type="text" required maxLength={160} value={formData.location} onChange={(event) => setFormData({ ...formData, location: event.target.value })} className="w-full border border-slate-300 bg-white p-3 outline-none transition-colors focus:border-red-600" placeholder="City, State / Province, Country" /></div>
