...
export default function AssignmentsManager() {
  ...
  return <div className="space-y-6">
    <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end"><div><p className="text-xs font-black uppercase tracking-[0.18em] text-[#b56b3b]">Operations menu</p><h1 className="mt-2 text-3xl font-black tracking-tight">Job assignments</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-[#66716a]">Workers can accept, act, and submit work. Only an authorised administrator can approve a submitted job as completed.</p></div><Link href="/hmsi-control?view=assignments" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#1e5b49] px-4 py-3 text-xs font-black uppercase tracking-widest text-white"><Users size={15} /> Create assignment</Link></div>
