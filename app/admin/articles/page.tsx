...
export const metadata: Metadata = { title: 'Content Management | HMSI Admin', robots: { index: false, follow: false } };
...
export default async function ArticlesPage() {
  ...
  return <EditorialWorkspace view="articles" reviewerEmail={reviewerEmail} />;
}
