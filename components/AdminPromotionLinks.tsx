...
import { Check, Copy, UserPlus, BriefcaseBusiness, LifeBuoy } from 'lucide-react';
import { useState } from 'react';

type PromotionLink = {
  id: 'volunteer' | 'worker' | 'get-help';
  title: string;
  description: string;
  path: string;
