...
import { CheckCircle2, Pencil, Save, Trash2, X, XCircle } from 'lucide-react';
...
const categories = ['medical', 'education', 'housing', 'emergency'];
const statuses = [
...
const emptyCreateForm = { title: '', description: '', category: 'medical', targetAmount: '', imageUrl: '', imagePath: '' };
