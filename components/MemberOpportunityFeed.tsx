...
type Opportunity = { id: string; title: string; description: string; category?: string; eligibility_note?: string | null; requires_hmsi_certificate?: boolean };
