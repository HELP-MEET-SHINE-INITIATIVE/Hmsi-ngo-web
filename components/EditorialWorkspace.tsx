...
type Article = {
  ...
  author_name: string; author_email: string; author_role: string; publisher_role: string | null; status: ArticleStatus; rejection_reason: string | null;
