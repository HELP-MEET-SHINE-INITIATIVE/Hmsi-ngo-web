...
const campaignPathways = [
  ...
  },
  {
    ...
    title: 'Become a fundraising ambassador',
  ...
  },
  {
    ...
    title: 'Build a community campaign',
    ...
    <section className={compact ? 'border-y border-[#d9d6ce] bg-[#e9f0e9] px-6 py-16' : 'border-y border-[#d9d6ce] bg-[#e9f0e9] px-6 py-20 sm:py-24'} aria-labelledby="fundraising-growth-heading">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-end">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.22em] text-[#b56b3b]">Fundraising growth, responsibly</p>
            <h2 id="fundraising-growth-heading" className="mt-4 text-4xl font-black leading-[1.02] tracking-[-0.04em] text-[#17221e] sm:text-5xl">Turn community energy into practical support.</h2>
            <p className="mt-5 max-w-xl text-base leading-7 text-[#66716a]">HMSI needs donors, volunteers, and workers who can help approved campaigns reach the right people. Choose a pathway, use accurate campaign information, and keep every promise grounded in verified programme records.</p>
        ...
        <div className="mt-10 border-t border-[#cbd8cd] pt-5 text-xs leading-5 text-[#66716a]">Campaign teams should use only approved HMSI copy, budgets, images, and updates. Do not promise a fundraising result, publish private beneficiary information, or collect donations outside HMSI’s approved channels.</div>
      </div>
    </section>
  );
}
